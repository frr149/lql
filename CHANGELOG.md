...
## [1.5.0](https://github.com/frr149/lql/releases/tag/v1.5.0) - 2026-05-20
...
- truncate epic backing-project name to Linear's 80-char limit
- repair fully-broken epic subcommand
...
- sanitize inline test data, remove personal identifiers
...
- add failing repro for broken epic subcommand
- document GitHub as sole remote for lql
- translate CLAUDE.md to English, remove private infra details
- bump version to 1.4.1
- release v1.3.0 ([#4](https://github.com/frr149/lql/pull/4))
