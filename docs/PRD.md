...
| **Cross-compile**         | No aplica                            | `cargo build --target x86_64-unknown-linux-musl` desde Mac → binario estático para homelab |
...
{
  "issue": "PROD-618",
  "title": "Configurar cron nocturno en homelab",
  "curator_said": "blog",
  "user_corrected": "homelab",
...
```text
Context: /Users/dev/projects/tokamak
  Team: PROD
  Project: Tokamak
  Label: tokamak
...
- despliegue nocturno en `homelab`
- `--create-label`
